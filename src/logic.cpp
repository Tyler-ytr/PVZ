...
void controller::buy_plant(int x,int y){
    if(y==0){
        switch (x){
            case 0:plant_catch=coldshotter;break;
            case 1:plant_catch=sunflower;break;
            case 2:plant_catch=peashotter;break;
            case 3:plant_catch=cherry_bomb;break;
            default:break;
        }
    }
}
void controller::plant_flowers(int x,int y) {
    ...
    if(plant_catch!=-1){
        switch(plant_catch){
            case peashotter:temp_plant=new peashooter(x,y,ID);ID+=1;plant_group.push_back(temp_plant);break;
            default:break;
        }
